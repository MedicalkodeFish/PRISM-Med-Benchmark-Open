...
The manuscript describing PRISM-Med is **under peer review**. The full paper is **not yet available** on a preprint server (no preprint DOI). Until journal publication, please cite **this repository** and the paper title and authors below; we will add the official DOI here after acceptance.
...
> Under peer review; no public preprint yet.
